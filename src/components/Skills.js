...
function HtmlDis(){
    return (
        <>
            <p className="Discription Discription_1">I have advanced knowledge of HTML, with professional-level mastery of structuring and organizing content for the web. My experience goes beyond basic tags—I focus on creating semantic, accessible, and scalable markup that forms the foundation of clean, maintainable front-end projects. From building responsive layouts to ensuring proper SEO-friendly structure, I treat HTML as the backbone of modern web development.</p>
        </>
    )
}
function CssDis(){
